...
const socks = [
  { x: '3%', y: '5%', size: 52, rotate: -25, delay: 0, shade: 'text-gray-300', color: '#ef4444' },
  { x: '8%', y: '45%', size: 48, rotate: 15, delay: 0.6, shade: 'text-gray-400', color: '#3b82f6' },
  { x: '2%', y: '78%', size: 56, rotate: -10, delay: 1.2, shade: 'text-gray-200', color: '#22c55e' },
  { x: '15%', y: '20%', size: 44, rotate: 30, delay: 0.3, shade: 'text-gray-300', color: '#f97316' },
  { x: '12%', y: '65%', size: 50, rotate: -20, delay: 0.9, shade: 'text-gray-400', color: '#a855f7' },
  { x: '85%', y: '8%', size: 50, rotate: 20, delay: 0.4, shade: 'text-gray-400', color: '#eab308' },
  { x: '90%', y: '40%', size: 54, rotate: -18, delay: 0.8, shade: 'text-gray-200', color: '#ec4899' },
  { x: '82%', y: '70%', size: 46, rotate: 25, delay: 1.1, shade: 'text-gray-300', color: '#06b6d4' },
  { x: '78%', y: '15%', size: 42, rotate: -30, delay: 0.2, shade: 'text-gray-400', color: '#84cc16' },
  { x: '92%', y: '85%', size: 48, rotate: 12, delay: 1.4, shade: 'text-gray-300', color: '#f43f5e' },
]
  ...
  return (
    <>
      <style>{`
        ...
        .scroll-arrow{animation:bounce-arrow 1.5s ease-in-out infinite}
      `}</style>
      <div className="relative overflow-hidden group min-h-screen flex flex-col items-center justify-center px-6 md:px-12">
        {socks.map((sock, i) => (
          <div
            key={i}
            ...
            style={{
              ...
              top: sock.y,
              width: sock.size,
              height: sock.size * 1.5,
              ['--hover-color' as string]: sock.color,
            }}
          >
            <SockSVG className="w-full h-full group-hover:drop-shadow-lg" />
            <style>{`.group:hover .sock-${i}{color:${sock.color} !important}`}</style>
          </div>
        ))}
        ...
        <div className="absolute bottom-8 left-8 flex flex-col items-center gap-1 text-dark-300">
          <span className="text-sm" style={{ fontFamily: 'Vazirmatn, sans-serif' }}>اسکرول کنید</span>
